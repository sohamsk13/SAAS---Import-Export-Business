...
const freightFormSchema = z.object({
  quotationNumber: z.string().min(2, "Quotation number is required"),
  origin: z.string().min(2, "Origin is required"),
  destination: z.string().min(2, "Destination is required"),
  containerType: z.string().min(2, "Container type is required"),
...
export function FreightQuotationForm() {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="number" placeholder="Enter additional charges" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
